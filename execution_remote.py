...
from instance_identity import get_machine_id, get_machine_name
...
def register_internal_runner(app, run_case_callable) -> None:
    ...
    from deployment_config import should_delegate_execution_to_clients
    ...
    while not _worker_stop.is_set():
        try:
            ...
            if _run_case_fn:
                ...
                from case_runner_local import run_case_on_local_app
