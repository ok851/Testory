...
from mobile_env_config import mobile_runtime_available, mobile_runtime_unavailable_reason
...
def _screenshot_dir() -> str:
    base = os.path.join(os.path.dirname(os.path.abspath(__file__)), "static", "mobile_screenshots")
