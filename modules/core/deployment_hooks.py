...
from modules.core.client_config_store import (
    get_auth_token,
    get_team_server_url,
    is_setup_complete,
    mark_setup_complete,
...
from modules.execution.execution_remote import register_routes as register_execution_routes
from modules.execution.execution_remote import start_client_worker
from modules.core.instance_identity import get_identity_info, get_instance_id, get_machine_id
from modules.auth.license_manager import license_manager
from modules.core.platform_sync import (
    build_website_payment_url,
    report_current_license_activation,
    report_license_activation,
    sync_product_user,
)
from modules.core.team_server_proxy import proxy_to_team_server, should_proxy_path
...
def register_deployment_hooks(app, db_factory: Callable[[], Any], user_model_class=None) -> None:
    ...
    def api_client_login_to_server():
        ...
        os.environ["TEAM_SERVER_URL"] = url
        try:
            from modules.core.team_server_client import TeamServerError, login as ts_login
...
def wire_internal_runner(app, run_case_fn) -> None:
    from modules.execution.execution_remote import register_internal_runner, set_run_case_handler
...
def patch_run_case_for_server(db, case_id: int, user_id: int):
    from modules.execution.execution_remote import create_server_execution_job
