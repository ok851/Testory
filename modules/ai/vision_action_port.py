...
class MobileVisionActionPort(VisionActionPort):
    ...
    def capture(self) -> CaptureFrame:
        from modules.mobile.mobile_agent_client import agent_screenshot
    ...
    def run_steps(self, steps: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        from modules.mobile.mobile_agent_client import agent_replay_steps
...
class DesktopVisionActionPort(VisionActionPort):
    ...
    def capture(self) -> CaptureFrame:
        from modules.desktop.desktop_visual_engine import capture_virtual_desktop_png
