...
class VLMGrounding:
    ...
    def _load_from_model_registry(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            from modules.ai.ai_selector_recovery import load_active_profile_for_inference
    ...
    def _detect_backend(self) -> Optional[str]:
        ...
        try:
            from modules.desktop.desktop_env_config import get_vlm_config
            cfg = get_vlm_config()
    ...
    def _call_cloud_vision_local(self, screenshot: bytes, prompt: str) -> Optional[str]:
        ...
        try:
            from modules.ai.ai_vision_local import vision_describe_cloud
...
def _vlm_config_signature() -> str:
    ...
    try:
        from modules.desktop.desktop_env_config import load_vlm_config
        fc = load_vlm_config()
        if fc:
