...
def _step_needs_locator_resolution(step: Dict[str, Any]) -> bool:
    from modules.ai.ai_step_normalization import is_overly_broad_css_selector
...
def resolve_plan_steps_locators_with_snapshot(
    ...
    try:
        from modules.hermes.hermes_heal_bridge import hermes_locator_resolve_enabled
    ...
    from modules.ai.ai_page_probe import build_locator_candidates_from_probe_entry, probe_registry_from_interactive_snapshot
    from modules.ai.ai_selector_recovery import (
        _apply_llm_choice,
        _extract_json_obj,
        _registry_lines,
