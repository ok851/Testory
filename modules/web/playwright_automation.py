...
# 🔥 导入增强型定位器模块
from modules.web.enhanced_locator import (
...
from modules.web.locator_visual_fallback import prepare_template_png_bytes_for_storage
from modules.web.locator_visual_fallback import match_template_in_viewport_png
...
def force_reset_execution_state():
    ...
    try:
        from modules.desktop.desktop_automation import sync_reset_desktop_automation
...
class PlaywrightAutomation:
    ...
    async def _verify_expected_text_with_local_vision(
        ...
        if v in ("0", "false", "no", "off"):
            return False
        from modules.ai.ai_vision_local import ocr_enabled, text_visible_in_screenshot, vision_enabled
    ...
    async def _wait_vision_condition(
        ...
        *,
        ...
        from modules.ai.ai_vision_insight import assert_vision_condition_on_png, wait_vision_enabled
    ...
    async def _extract_vision_from_page(self, target_page, prompt_nl: str) -> str:
        ...
        from modules.ai.ai_vision_insight import extract_vision_from_png
    ...
    async def _try_vlm_ground_click_recovery(
        ...
        if not goal or not target_page:
            return False
        try:
            from modules.hermes.hermes_heal_bridge import merge_vlm_ground_into_locator_candidates
    ...
    async def get_accessibility_outline_text(self, max_lines: int = 48) -> str:
        ...
        if not root:
            return ""
        from modules.ai.ai_page_probe import format_a11y_snapshot_lines
    ...
    async def capture_step_failure_bundle(
        ...
        try:
            from modules.execution.execution_diag_bundle import build_failure_bundle, classify_failure_with_llm
    ...
    async def execute_multiple_test_cases(self, case_ids: List[int], db) -> Dict[str, Any]:
        ...
        def build_execution_steps(steps):
            ...
            for step in steps:
                ...
                from modules.execution.step_executor import enrich_execution_step
        ...
        for index, case_id in enumerate(case_ids):
            ...
            try:
                ...
                from modules.auth.auth_batch_helpers import evaluate_batch_case_status, summarize_batch_case_error
                ...
                try:
                    from modules.auth.auth_batch_helpers import mark_session_ready_after_case
    ...
    async def _execute_case_steps(self, execution_steps: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        """
        try:
            from modules.execution.step_executor import case_steps_include_desktop
...
def sync_run_api_case_for_batch(
    ...
    try:
        ...
        run_history_id = None
        try:
            from modules.auth.auth_batch_helpers import summarize_batch_case_error
...
def sync_execute_multiple_test_cases(case_ids: List[int], db, should_stop=None, execution_context=None):
    ...
    try:
        ...
        if not machine_lock_acquired:
            ...
            try:
                from modules.auth.auth_batch_helpers import build_batch_lock_fail_results
    ...
    try:
        ...
        automation._execution_context = execution_context
        from modules.auth.auth_batch_helpers import batch_worker_timeout_seconds
        ...
        if is_timeout and snap is not None:
            try:
                from modules.auth.auth_batch_helpers import finalize_batch_timeout_results
...
# 网络爬虫文本提取功能
try:
    from modules.web.crawler_text_extractor_adapter import extract_text_from_page, extract_all_page_text, extract_multiple_elements
...
# 高性能文本提取功能
try:
    from modules.web.high_performance_text_extractor import HighPerformanceTextExtractor
