...
def element_picker_available() -> bool:
    try:
        from modules.desktop.desktop_picker import desktop_picker_available as desk_ok
...
def _start_web_channel_picker(
    *,
    ...
    from modules.web.web_dom_picker import sync_start_web_dom_picker
...
def stop_element_picker(*, fast: bool = False) -> Dict[str, Any]:
    ...
    if was_web:
        try:
            from modules.web.web_dom_picker import sync_stop_web_dom_picker
...
def get_element_picker_status(*, consume_last_pick: bool = False) -> Dict[str, Any]:
    ...
    if web_on:
        try:
            from modules.web.web_dom_picker import sync_get_web_dom_picker_status
