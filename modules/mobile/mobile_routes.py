...
from modules.mobile.mobile_adb_control import adb_press_back, adb_press_home, adb_swipe, smart_tap
from modules.mobile.mobile_env_config import (
...
from modules.mobile.mobile_agent_client import (
...
def _adb_local_connect_fallback(udid: str, *, gateway_error: str = "") -> Dict[str, Any]:
    ...
    try:
        from modules.mobile.mobile_assistant_bundles import assistant_installed_on_device
...
def _gateway_diagnostics() -> dict:
    ...
    try:
        from modules.mobile.mobile_service_bootstrap import _GATEWAY_PROC
        proc = _GATEWAY_PROC
...
def _mirror_payload(udid: str, session_id: str, *, client_host: str = "") -> Dict[str, Any]:
    ...
    from modules.mobile.mobile_env_config import scrcpy_available, scrcpy_bridge_url
    from modules.mobile.mobile_mirror import external_scrcpy_status
    ...
    if udid:
        try:
            from modules.mobile.mobile_scrcpy_bridge import (
...
def _connect_response_with_mirror(
    ...
    *,
    ...
    from modules.mobile.mobile_mirror import start_scrcpy_mirror
    from modules.mobile.mobile_env_config import scrcpy_available
...
def register_mobile_routes(app, *, api_error_handler, log_api_request, role_required=None):
    ...
    def api_mobile_scrcpy_diagnostics():
        ...
        if udid:
            try:
                from modules.mobile.mobile_scrcpy_bridge import _diagnose_device_for_scrcpy, _generate_param_profiles
    ...
    def api_mobile_mirror_status():
        ...
        if warm and udid:
            ...
            try:
                from urllib.parse import quote
                from modules.mobile.mobile_env_config import scrcpy_bridge_url
    ...
    def api_mobile_connection_status():
        ...
        if blocked:
            return blocked
        from modules.mobile.mobile_device_manager import get_connected_udid, check_mobile_health
        from modules.mobile.mobile_env_config import scrcpy_available
        from modules.mobile.mobile_mirror import external_scrcpy_status
    ...
    def api_mobile_mirror_stop():
        ...
        udid = _resolve_request_udid(body)
        if session_id:
            from modules.mobile.mobile_mirror import stop_mirror
        ...
        if udid:
            try:
                ...
                pass
            try:
                from modules.mobile.mobile_mirror import stop_external_scrcpy
    ...
    def api_mobile_mirror_launch_external():
        ...
        if not udid:
            return jsonify({"success": False, "error": "请先连接设备"}), 400
        from modules.mobile.mobile_mirror import launch_external_scrcpy
    ...
    def api_mobile_tap_at():
        ...
        if not udid:
            return jsonify({"success": False, "error": "请先连接设备"}), 400
        try:
            from modules.mobile.mobile_agent_client import agent_replay_step
    ...
    def api_mobile_record_step():
        ...
        from modules.mobile.mobile_ui_probe import pick_at_point
    ...
    def api_mobile_studio_bootstrap():
        ...
        from modules.mobile.mobile_device_profiles import list_frame_presets
        from modules.mobile.mobile_assistant_bundles import assistant_installed_on_device
    ...
    def api_mobile_device_pair():
        ...
        from modules.mobile.mobile_sync_store import pair_code_payload
    ...
    try:
        from modules.mobile.mobile_sync_store import register_sync_routes
