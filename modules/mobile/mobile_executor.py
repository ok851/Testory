...
from modules.mobile.mobile_device_manager import check_appium_server, set_connected_udid
...
class MobileExecutor:
    ...
    def __init__(self, capabilities: Optional[Dict[str, Any]] = None) -> None:
        ...
        self._screenshot_dir = os.path.join(
            os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "static", "mobile_screenshots"
        )
    ...
    def connect(self, capabilities: Optional[Dict[str, Any]] = None) -> None:
        ...
        from modules.mobile.mobile_env_config import appium_server_url
    ...
    def execute_step(self, step: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self._driver is None:
            ...
            from modules.mobile.mobile_env_config import mobile_driver_mode, requires_appium_for_execution
    ...
    def _action_swipe(self, step: Dict[str, Any]) -> Dict[str, Any]:
        from modules.mobile.mobile_automation import parse_mobile_spec
