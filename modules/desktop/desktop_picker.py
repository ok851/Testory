...
def _picker_child_main(cfg_path: str) -> None:
    ...
    try:
        from modules.desktop.desktop_visual_picker import CAPTURE_UI_ENGINE
    except Exception:
    ...
    from modules.desktop.desktop_visual_picker import VisualRegionPickerOverlay
...
def _spawn_picker_process(
    ...
    *,
    ...
    # 源码布局下模块位于 modules/desktop/，子进程 sys.path[0] 不再是仓库根，
    # 需显式注入 PYTHONPATH 以保证 modules.* 绝对导入可用。
