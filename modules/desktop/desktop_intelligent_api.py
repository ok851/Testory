...
# 导入所有模块
from modules.desktop.desktop_skill_framework import SkillContext, SkillResult, get_global_registry
from modules.desktop.desktop_fuzzy_search import find_apps_by_query, parse_user_intent, suggest_queries
from modules.desktop.desktop_runtime_snapshot import capture_window_snapshot, get_snapshot_summary
from modules.desktop.desktop_auto_setup import ensure_initialized, get_quick_start_guide

# 确保内置技能已注册
from modules.desktop import desktop_builtin_skills
