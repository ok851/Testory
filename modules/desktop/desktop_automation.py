...
class DesktopAutomation:
    ...
    def __init__(self):
        self._screenshot_dir = os.path.join(
            os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "static", "desktop_screenshots"
        )
    ...
    def _perform_visual_step(self, step: Dict[str, Any]) -> Dict[str, Any]:
        from modules.desktop.desktop_hybrid_locator import (
        ...
        from modules.desktop.desktop_input import _enum_visible_windows
        ...
        if result.resolved_via == "shell_com":
            from modules.desktop.desktop_shell_application import execute_shell_application_action
            ...
            from modules.desktop.desktop_shell_listview import execute_shell_listview_action
    ...
    def _find_hwnd_after_launch(self, launch_value: str, timeout: float = 10.0) -> tuple:
        from modules.desktop.desktop_input import get_foreground_hwnd, resolve_hwnd_from_spec, _hwnd_title_class
    ...
    def execute_step(self, step: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if action == "verify":
            ...
            from modules.desktop.desktop_captcha import run_desktop_verify_at_point
    ...
    def _attach_window(self, step: Dict[str, Any], spec: Dict[str, Any]) -> Dict[str, Any]:
        from modules.desktop.desktop_input import get_foreground_hwnd, resolve_hwnd_from_spec, _hwnd_title_class
        from modules.desktop.desktop_run_context import get_desktop_run_context, spec_has_window_target
    ...
    def _verify_window_exists(
        ...
        *,
        ...
        from modules.desktop.desktop_input import resolve_hwnd_from_spec
    ...
    def _try_get_window_rect_from_step(step: Dict[str, Any]) -> Optional[Tuple[int, int, int, int]]:
        ...
        try:
            ...
            pass
        try:
            from modules.desktop.desktop_input import hwnd_at_screen_point
            from modules.desktop.desktop_win32_snapshot import get_window_rect, get_top_level_window
    ...
    def inspect_uia_tree(self, max_depth: int = 4, max_nodes: int = 120) -> List[Dict[str, Any]]:
        try:
            from modules.desktop.desktop_uia_core import dump_foreground_uia_tree
...
def sync_desktop_verify_element(
    ...
    try:
        ...
        from modules.desktop.desktop_uia_snapshot import resolve_uia_click_point
