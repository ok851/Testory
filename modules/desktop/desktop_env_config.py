...
def load_app_alias_specs() -> Dict[str, Dict[str, Any]]:
    ...
    try:
        from modules.desktop.desktop_app_catalog import catalog_aliases_map
...
def prepare_desktop_step(step: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "launch_app":
        ...
        from modules.desktop.desktop_run_context import guess_window_title_from_description, spec_has_window_target
...
def _catalog_public_meta() -> Dict[str, Any]:
    try:
        from modules.desktop.desktop_app_catalog import catalog_meta
...
def setup_vlm(config: Dict[str, Any], *, persist: bool = True) -> Dict[str, Any]:
    ...
    """
    from modules.ai.vlm_grounding import configure_vlm, get_runtime_vlm_config
