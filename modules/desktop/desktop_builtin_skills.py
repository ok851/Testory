...
# 导入技能框架
from modules.desktop.desktop_skill_framework import DesktopSkill, SkillContext, SkillResult, SkillStatus, register_skill

# 尝试导入桌面自动化模块
if sys.platform == "win32":
    try:
        from modules.desktop.desktop_discovery import resolve_executable, resolve_executable_with_meta, format_resolve_error
        from modules.desktop.desktop_runtime import parse_desktop_spec
        from modules.desktop.desktop_fuzzy_search import find_apps_by_query, parse_user_intent
        from modules.desktop.desktop_runtime_snapshot import capture_window_snapshot, find_control_by_fuzzy_match
    except ImportError:
        ...
        try:
            ...
            if not control:
                ...
                if fuzzy_query:
                    ...
                    from modules.desktop.desktop_runtime_snapshot import find_control_by_fuzzy_match, ControlNode
