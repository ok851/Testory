...
def _match_shell_item_name(actual: str, expected: str) -> bool:
    from desktop_shell_listview import _match_icon_name
...
def execute_shell_application_action(
    ...
    *,
    ...
    from desktop_shell_listview import icon_name_from_step
...
def try_resolve_shell_application_step(step: dict) -> Optional[ShellComTarget]:
    if not shell_com_enabled():
        return None
    from desktop_shell_listview import icon_name_from_step, is_desktop_listitem_step
